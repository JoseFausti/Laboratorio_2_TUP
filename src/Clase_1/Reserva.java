...
public class Reserva extends Persona {
    ...
    private ArrayList<Vuelo> vuelos; // Relacion de Agregacion de la Clase Vuelos en la Clase Clase_1.Reserva
    ...
    public void Informacion() {
        ...
        System.out.println("Clase_1.Reserva de vuelo: " + reservaVuelo);
